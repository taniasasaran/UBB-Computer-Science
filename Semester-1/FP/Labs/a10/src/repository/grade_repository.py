...
class GradeCollection(Collection):
    def __init__(self):
        super().__init__()
    ...
    def __delitem__(self, item_to_be_removed):
        for i, grade in enumerate(self.data):
            if grade.student_id == item_to_be_removed.student_id and grade.discipline_id == item_to_be_removed.discipline_id:
                del self.data[i]
                break
...
class GradeRepository:
    ...
    def remove_grade(self, grade_to_be_removed):
        ...
        :return: None
        """
        self.data.__delitem__(grade_to_be_removed)
...
class GradeTextFileRepository(GradeRepository):
    ...
    def _save_file(self):
        ...
        for grade in self.data.__iter__():
