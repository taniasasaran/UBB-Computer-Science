...
from src.domain.validators_and_errors import StudentValidator, StudentRepositoryError, StudentValidatorException
...
class StudentRepositoryTest(unittest.TestCase):
    ...
    def test__add_students_in_repository__length_20(self):
        self._repository.add_20_students_in_repository()
        self.assertEqual(len(self._repository), 20)
    ...
    def test__add_student__invalid_name__exceptions_raised_and_catched(self):
        with self.assertRaises(StudentValidatorException):
            self._repository.add_student(Student(3, "916"))
