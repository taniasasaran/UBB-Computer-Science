...
segment  data use32 class=data
	...
	message  db "Suma celor doua numere decimale este s=%x(hexadecimal)", 0  ;mesajul ce se va printa pe ecran, sir de caractere(bytes) si la fiecare variabila specificam tipul de data(baza in care afisam)
