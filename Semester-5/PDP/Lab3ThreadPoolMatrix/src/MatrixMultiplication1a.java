...
public class MatrixMultiplication1a {
    ...
    public static void main(int[][] matrixA, int[][] matrixB, int[][] resultMatrix, int size, int count) {
        ...
        for (int taskIndex = 0; taskIndex < TASK_COUNT; taskIndex++) {
            ...
            threads[taskIndex] = new Thread(() -> multiplyRows(matrixA, matrixB, resultMatrix, start, end));
        ...
        System.out.println("Row | Time: " + (endTime - startTime) + "ms | " + TASK_COUNT + " threads | matrix size " + MATRIX_SIZE);
    }
