...
private:
    ...
    std::vector<Operation*> undoStackUser;
    std::vector<Operation*> redoStackUser;
public:
    ...
    // this function gets a movie as a parameter, calls the add function from the repository and throws an exception if raised
    ...
    // this function gets a title and a genre as parameters, calls the remove function from the repository and throws an exception if raised

    void update(std::string title, std::string genre, Movie movie);
    // this function calls the update function from the repository and throws an exception if raised
    ...
    std::vector<Movie> getRepoData(){return this->repository.getData();}
